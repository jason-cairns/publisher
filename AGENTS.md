...
- Keep Prolog pure and modern where possible, following Markus Triska's style at https://www.metalevel.at/prolog: relations first, DCGs for sequences, clear predicate names, and side effects isolated at the boundary.
